...
<body>
	...
	<div class="ui centered grid">
		...
		<div class="four wide column">
			<form id="imgform" name="imgform" action="UploadHead" method="POST"
				enctype="multipart/form-data">
				<input type="file" name="img" id="headpic"
					onChange="uploading(this);" accept="image/jpeg,image/jpg,image/png"
					hidden="hidden">
			</form>
			<form class="ui form" action="#" id="infoform" method="POST">
				<div id="imgerror"></div>
				<div class="field" data-tooltip="点击上传头像">
					<a href="javascript:selectimg();"><img id="headimg"
						class="ui small circular centered image"
						src="images/dp/default.jpg"></a>
				</div>
				<div id="errormsg2"></div>
				<div class="ui error message" id="errormsg"></div>
				<div class="field">
					<input type="text" name="telnum" id="telnum" placeholder="请输入电话号码"
				...
				<div class="field">
					<div class="ui center aligned grid">
						...
						<div class="eight wide column">
							<input type="button" id="getcode" style="width: 100%"
								class="medium teal ui button" value="获取验证码">
						</div>
					</div>
				</div>
				<div class="field">
				...
				<div class="field">
					<input type="password" name="reqpwd" id="reqpwd" placeholder="确认密码"
						required="required">
				</div>
				<div class="ui center aligned grid">
					<div class="row"></div>
					<div class="ui slider checkbox">
						<input type="checkbox" name="checkrule" id="checkrule"
							name="newsletter"> <label>接受<a href="#">条款和条件</a></label>
					</div>
					<div class="row"></div>
					<div class="field">
						<input type="button" class="ui basic button"
							onclick="return submitit();" value="确认注册">
					</div>
				</div>
			</form>
		</div>
