...
<body>
	...
	<div class="ui center aligned grid">
		<h1 class="ui icon header">
			...
			<div class="content">
				忘记密码了吗？
				<div class="sub header">来这里重置你的密码吧</div>
			</div>
		</h1>
	</div>
	...
	<div class="ui centered grid">
		...
		<div class="four wide column">
			<form class="ui form" action="Forget" id="infoform" method="POST">
				...
				<div class="ui center aligned grid">
					<div class="row"></div>
					<div class="field">
						<input type="button" id="forgetbtn" class="ui basic button" value="重置密码">
					</div>
				</div>
			</form>
		</div>
