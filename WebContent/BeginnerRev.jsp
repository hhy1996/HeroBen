...
<body>
	...
	<div class="ui center aligned grid">
		<h1 class="ui icon header">
			...
			<div class="content">
				如何接受任务
				<div class="sub header">化身Ben去帮忙吧</div>
			</div>
		</h1>
	</div>
		...
		<div class="eight wide column">
			...
			<div class="ui steps">
				...
				<div class="step">
					...
					<div class="content">
						<div class="title">
							<font><font>进行任务</font></font>
						</div>
						<div class="description">
							<font><font>开始执行任务</font></font>
						</div>
					</div>
				</div>
			</div>
			...
			<h4 class="ui horizontal divider header">
				<i class="repeat icon"></i><font><font></font></font>
			</h4>
